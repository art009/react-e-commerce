...
const PaymentForm = ({ checkoutToken, shippingData, backStep, onCaptureCheckout, nextStep, timeout }) => {
  ...
  return (
    <>
      ...
      <Divider />
      <Typography variant="h6" gutterBottom style={{mergin: '20px 0' }}>Тип оплаты</Typography>
            ...
            <form onSubmit={(e) => handleSubmit(e, elements, stripe)}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                ...
                <Button type="submit" variant="contained" disabled={!stripe} color="primary">
                  Оплатит {checkoutToken.live.subtotal.formatted_with_symbol}
                </Button>
              </div>
            </form>
          )}
